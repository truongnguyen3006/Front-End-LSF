...
import { App as AntdApp, Button, Card, Col, Empty, Row, Spin, Statistic } from 'antd';
import { DashboardOutlined, DollarCircleOutlined, ShoppingOutlined, UserOutlined } from '@ant-design/icons';
    ...
    <div className="space-y-6">
      ...
      <Card className="app-admin-card border-0">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <h2 className="text-xl font-semibold tracking-tight">Framework Evidence</h2>
            <p className="mt-2 text-sm leading-6 text-[var(--color-secondary)]">
              Mở nhanh khu vực chứng minh LSF để xem availability theo SKU, outbox recent và các quick links quan sát hệ thống.
            </p>
          </div>
          <Link href="/admin/framework">
            <Button type="primary" icon={<DashboardOutlined />} className="!bg-[var(--color-primary)]">
              Mở Framework Evidence
            </Button>
          </Link>
        </div>
      </Card>
